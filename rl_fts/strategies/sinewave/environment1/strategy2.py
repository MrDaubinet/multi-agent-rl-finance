'''
	Sinewave:
		...
		Strategy - 2:
			DRL: 
				PPO with custom configuration parameters
...
# Environment
from rl_fts.environments.sinewave.environment9 import create_env, reward_clipping, max_episode_reward, max_net_worth
# episode_max_reward, net_worth_max
...
class PPO_Sinewave_BSH_NWC(Strategy):
		...
		def __init__(self):
				...
				self.log_name = "sinewave/environment9/strategy2"
				...
				threshold_max_worth = 0.9
				self.net_worth_threshold = threshold_max_worth*max_net_worth(env_train_config)
