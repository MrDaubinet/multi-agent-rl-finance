...
from rl_fts.strategies.sinewave.environment8.models.model1 import Model
# Environment
from rl_fts.environments.sinewave.environment8 import create_env, normalization_info
...
class PPO_Sinewave_BSH_PBR(Strategy):
    ...
    def __init__(self):
        ...
        model: ModelConfigDict = {
            "custom_model": "PPO_Sinewave_BSH_PBR_Model1",
            "custom_model_config": {
                "mean": norm_info["mean"],
                "var": norm_info["var"]
            }
