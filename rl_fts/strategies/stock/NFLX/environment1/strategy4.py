...
# Environment
from rl_fts.environments.stock.environment1 import create_env, normalization_info
from rl_fts.environments.stock.environment1 import reward_clipping_training, max_episode_reward_training, max_episode_reward_evaluation
...
class PPO_NFLX_BSH_NWC(Strategy):
	...
	def __init__(self):
			...
			self.log_name = "stock/NFLX/environment1/strategy4"
			...
			self.max_episode_reward_evaluation = max_episode_reward_evaluation()
