...
from rl_fts.strategies.stock.NFLX.environment2.models.model1 import KerasBatchNormModel
# Environment
from rl_fts.environments.stock.NFLX.environment2 import create_env, normalization_info, reward_clipping
...
class PPO_NFLX_PBSH_NWC(Strategy):
	...
	def __init__(self):
			...
			self.log_name = "stock/NFLX/environment2/strategy2"
