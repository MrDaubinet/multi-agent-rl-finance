...
# Reward Schemes
from rl_fts.tensortradeExtension.rewards.proportional_short_net_worth_change import PSNWC
# Renderer
...
def get_reward_clipping(price_stream):
    ...
    for t in range(0, len(price_stream)-1):
        ...
        proportional_price_difference = (price_stream[t] - price_stream[t+1]) / price_stream[t]
        # update biggest gain
