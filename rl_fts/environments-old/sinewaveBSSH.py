...
# Action Scheme
from rl_fts.tensortradeExtension.actions.buy_sell_short_hold import BSSH
# Renderer
from rl_fts.tensortradeExtension.renderer.bsshPositionChangeChart import PositionChangeChart
from rl_fts.tensortradeExtension.renderer.emptyRenderer import EmptyRenderer
# rewarch scheme
from rl_fts.tensortradeExtension.rewards.short_net_worth_change import SimpleShortNetWorthChange
...
def generate_env(dataframe, config):
  ...
  # set reward scheme
  reward_scheme = SimpleShortNetWorthChange()
  # set action scheme
  action_scheme = BSSH(
    cash=cash,
    asset=asset,
