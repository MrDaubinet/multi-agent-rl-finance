...
# Action Scheme
from rl_fts.tensortradeExtension.actions.proportion_buy_hold_sell import BSHC
# Reward Scheme
from rl_fts.tensortradeExtension.rewards.net_worth_change import ComplexNetWorthChange
# Renderer
...
def generate_env(dataframe, config):
  ...
  # set reward scheme
  reward_scheme = ComplexNetWorthChange(
