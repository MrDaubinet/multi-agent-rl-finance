'''
  Strategy 1:
    ...
    Action Space: 
      Enter Short -> short the asset
      Exit Short -> Exit short
      hold -> do nothing
      percent -> the percentage of funds to enter
    Reward Strategy:
...
# Environments
from rl_fts.environments.sinewaveSHC import create_env
...
class Strategy1(Strategy):
  ...
  def __init__(self) -> None:
    ...
    self.log_name = "sinewaveSHC/strategy1"
