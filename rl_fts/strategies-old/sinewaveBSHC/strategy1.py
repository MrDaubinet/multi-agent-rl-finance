'''
  Strategy 1:
    ...
    Action Space: 
      ...
      sell -> sell
      hold -> do nothing
      percent -> the percentage of funds to buy / sell
    Reward Strategy:
      Complex Position Based Returns
'''
...
# Environments
from rl_fts.environments.sinewaveBSHC1 import create_env

class PPOSinewaveEnvBSHC(Strategy):
    ...
    def __init__(self):
      ...
      self.log_name = "sinewaveBSHC/strategy1"
