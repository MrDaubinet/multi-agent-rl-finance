...
from tensortrade.env.default import actions, rewards, observers, informers, renderers, stoppers
from rl_fts.tensortradeExtension.env.tradingEnv import TradingEnv
...
def create(portfolio: 'Portfolio',
    ...
    **kwargs : keyword arguments
    ...
    action_scheme = actions.get(action_scheme) if isinstance(
        action_scheme, str) else action_scheme
    reward_scheme = rewards.get(reward_scheme) if isinstance(
